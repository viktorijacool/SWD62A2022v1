...
namespace WebApp
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            //TCA
            //the Startup.cs (this class) needs to know what life expectancy the service class needs to be created with
             ...
             * e.g. if there are 50 users and there are 2 calls (GetItem()) for ItemsRepository (within the ItemsService), then 50x1=50 instances of ItemsRepository in memory ...
             * 
             * 
             * 
             */
